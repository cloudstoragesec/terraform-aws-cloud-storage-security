resource "aws_cognito_user_pool" "main" {
  admin_create_user_config {
    ...
    invite_message_template {
      ...
      email_message = "A new account has been created for you in the ${local.product_name} Console.<br/>Your account credentials are provided below:<br/><br/> User Name: {username}<br/> Temporary Password: {####}<br/><br/>This temporary password will expire in 7 days.<br/><br/> Sign in at ${local.console_url} to change your password.<br/><br/>Have Fun,<br/>Cloud Storage Security<br/>support@cloudstoragesec.com<br/>801-410-0408"
