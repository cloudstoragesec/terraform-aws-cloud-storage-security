  ...
  container_definitions = jsonencode([
    {
      ...
      environment : [
        ...
        { "name" : "CROSS_ACCOUNT_ROLE_NAME", "value" : "${var.service_name}RemoteRole-${local.application_id}" },
        { "name" : "CROSS_ACCOUNT_POLICY_NAME", "value" : "${var.service_name}RemotePolicy-${local.application_id}" },
